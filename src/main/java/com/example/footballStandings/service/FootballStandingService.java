package com.example.footballStandings.service;
...
import com.example.footballStandings.model.ErroResponse;
import com.example.footballStandings.Utils;
...
import com.example.footballStandings.model.Country;
import com.example.footballStandings.model.FootBallResponse;
import com.example.footballStandings.model.League;
import com.example.footballStandings.model.Standing;
import com.example.footballStandings.model.Team;
...
public class FootballStandingService {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(FootballStandingService.class);
	 ...
	 */
	public Standing getStandingDetails(String countryName, League leagueDetails, Team teamDetails)
